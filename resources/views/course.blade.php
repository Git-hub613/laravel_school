<x-layout>
    ...
    <form action="/course/store" method="POST" enctype="multipart/form-data">
        ...
        <div class="mt-10 flex items-center gap-5 ">
                <div class="flex gap-2"><input type="radio" name="type" id="type" value="Online">Online</div>
                <div class="flex gap-2">
                <input type="radio" name="type" id="type" value="Physical">Physical
                </div>
            </div>
        </div>
            ...
            @foreach ($courses as $course)
               <div class="overflow-hidden rounded-lg hover:shadow-2xl max-w-fit bg-gray-300">
                ...
                <div class="flex items-center">
                    <span class="text-red-700 ml-4"><i class="fa-regular fa-circle-dot"></i></span>
